...
public class PT2Controller implements ActionListener {
	private PT2View view;
    private float hangsoA;
    private float hangsoB;
    private float hangsoC;
 
    public PT2Controller(PT2View view) {
        this.view = view;
    ...
    public PT2View getView() {
        return view;
    }
 
    public void setView(PT2View view) {
        this.view = view;
    }
}
